...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	{ 0, 24576,  LPXO,     0, 0,  30720000,  900, VDD_RAW(925) },
	{ 0, 61440,  PLL_3,    5, 11, 61440000,  900, VDD_RAW(925) },
	{ 0, 122880, PLL_3,    5, 5,  61440000,  900, VDD_RAW(925) },
	{ 0, 184320, PLL_3,    5, 4,  61440000,  900, VDD_RAW(925) },
	{ 0, MAX_AXI_KHZ, AXI, 1, 0,  61440000,  900, VDD_RAW(925) },
	{ 1, 122000, PLL_3,    5, 2,  61440000,  875, VDD_RAW(925) },
	{ 1, 245000, PLL_3,    5, 1,  19200000,  875, VDD_RAW(925) },
	{ 1, 307200, PLL_3,    5, 1,  19200000,  900, VDD_RAW(950) },
	{ 1, 384000, PLL_1,    2, 0,  19200000,  900, VDD_RAW(950) },
	{ 1, 460800, PLL_3,    5, 1,  19200000,  925, VDD_RAW(975) },
	{ 1, 537600, PLL_2,    3, 0,  19200000,  950, VDD_RAW(975) },
	{ 1, 614400, PLL_2,    3, 0,  19200000,  950, VDD_RAW(975) },
	{ 1, 691200, PLL_2,    3, 0,  19200000,  975, VDD_RAW(1025) },
	{ 1, 768000, PLL_2,    3, 0,  19200000, 1000, VDD_RAW(1025) },
	{ 1, 844800, PLL_2,    3, 0,  19200000, 1000, VDD_RAW(1050), &pll2_tbl[0] },
	{ 1, 921600, PLL_2,    3, 0,  19200000, 1025, VDD_RAW(1075), &pll2_tbl[0] },
	{ 1, 998400, PLL_2,    3, 0,  19200000, 1025, VDD_RAW(1075), &pll2_tbl[0] },
	{ 1, 1075200, PLL_2,   3, 0,  19200000, 1050, VDD_RAW(1125), &pll2_tbl[1] },
	{ 1, 1152000, PLL_2,   3, 0,  19200000, 1075, VDD_RAW(1125), &pll2_tbl[1] },
	{ 1, 1228800, PLL_2,   3, 0,  19200000, 1100, VDD_RAW(1150), &pll2_tbl[2] },
	{ 1, 1305600, PLL_2,   3, 0,  19200000, 1125, VDD_RAW(1175), &pll2_tbl[2] },
	{ 1, 1382400, PLL_2,   3, 0,  19200000, 1150, VDD_RAW(1200), &pll2_tbl[2] },
	{ 1, 1459200, PLL_2,   3, 0,  19200000, 1200, VDD_RAW(1250), &pll2_tbl[3] },
	{ 1, 1536000, PLL_2,   3, 0,  19200000, 1275, VDD_RAW(1300), &pll2_tbl[4] },
	{ 1, 1612800, PLL_2,   3, 0,  19968000, 1325, VDD_RAW(1350), &pll2_tbl[5] },
	{ 1, 1689600, PLL_2,   3, 0,  19968000, 1375, VDD_RAW(1400), &pll2_tbl[5] },
	{ 1, 1766400, PLL_2,   3, 0,  19968000, 1425, VDD_RAW(1425), &pll2_tbl[6] },
	{ 1, 1843200, PLL_2,   3, 0,  19968000, 1450, VDD_RAW(1450), &pll2_tbl[7] },
	{ 1, 1920000, PLL_2,   3, 0,  19968000, 1475, VDD_RAW(1475), &pll2_tbl[7] },
	{ 1, 1996800, PLL_2,   3, 0,  19968000, 1500, VDD_RAW(1500), &pll2_tbl[7] },
	{ 1, 2016000, PLL_2,   3, 0,  20160000, 1500, VDD_RAW(1500), &pll2_tbl[7] },
	{ 0 }
};
